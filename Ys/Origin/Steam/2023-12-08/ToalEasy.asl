state("yso_win"){
	byte roomID : 0x0076A534, 0x0; // +74d950
	// byte boostflag : 0x002B9AC, 0x0;
	// byte dbjumpflag : 0x004F8AC, 0x0;
	float SBHP99999 : 0x02B99DC, 0x4, 0x880;
	float VelagunderHP : 0x02B9A68, 0x20, 0x98;
	byte NumofDulessHP : 0x001B648, 0x0;
	float SPBossHP : 0x02B99D8, 0x4, 0x98;
	float FloorBossHP : 0x006D6004, 0x1C;
